...
parser = OptionParser.new do |act|
  act.on('--jobs-csv TEXT', 'path to the csv file containing the list of jobs') do |arg|
    args.jobs_csv_path = arg
  end

  act.on('--job-seekers-csv [TEXT]', 'path to the csv file containing the list of job seekers') do |arg|
